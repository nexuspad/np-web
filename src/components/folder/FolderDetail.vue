      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item text-light px-1" v-if="folder.folderId === -1">{{npContent('new folder')}}</li>
            <li class="nav-item text-light px-1" v-if="folder.folderId !== -1">{{npContent('update folder')}}</li>
          </ul>

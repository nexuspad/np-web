  ...
  <div>
    <form>
      <div class="form-group row">
        <div class="col">
          <input type="text" class="form-control input-underline" placeholder="title (optional)" v-model="bookmark.title">
        </div>
      </div>
      <div class="form-group row">
        <div class="col">
      ...
      <div class="form-group row">
        <div class="col">
          <textarea-autosize class="form-control input-underline" placeholder="notes" v-model="bookmark.note"></textarea-autosize>
        </div>
      </div>
    </form>
    <b-navbar toggleable="md" fixed="top" type="dark" variant="dark">
      <b-collapse is-nav id="editor_nav_menu_collapse">
        <b-navbar-nav>
          ...
          <b-nav-text v-if="!bookmark.entryId">new bookmark</b-nav-text>
          <b-nav-text v-if="bookmark.entryId">edit bookmark</b-nav-text>
        </b-navbar-nav>
        <!-- right aligned nav items -->
        <b-navbar-nav class="ml-auto">
          <b-button-group class="mx-1">
            <button class="btn btn-primary" v-on:click="collectTags(); save($event, bookmark)">save</button>
          </b-button-group>
          <b-button-group class="mx-1">
